...
<body>-->
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li><button onClick="RevertFW();"><span class="fa fa-history"></span> Revert</button></li>
							...
							<table width="100%" border="0" id="datatbl" class="table table-striped mainpanel-table">
								<thead>	
									<tr class="rowtitle">
										...
										<td style="width:9%;">Field Work Date</td>
										...
										<td style="width:9%;">Approval Date</td>
									...
									<tr class="rowsearch">
									  ...
									  <td><input list="SearchDateFiled" class="search" disabled>
										<?php
											$query = "SELECT distinct date_format(approvaldatetime, '%Y-%m-%d') as datefiled FROM portalfieldwork where dataareaid = '$dataareaid' and status != 0";
											$result = $conn->query($query);	
								...
								<tbody id="result">
									...
									case when pf.daytype = 0 then 'Whole Day'
										...
										date_format(pf.approvaldatetime, '%Y-%m-%d') as datefiled
									...
									{ 
										...
										<tr class="<?php echo $rowclass; ?>">
											...
											<td style="width:24%;"><?php echo $row['details'];?></td>
		...
		$( ".search" ).on( "keydown", function(event) {
		  if(event.which == 13){
			...
			var data=[];
			 ...
			 $.ajax({
						type: 'GET',
						url: 'approverviewfieldworkformprocess.php',
