								...
								<thead>	
									...
									<tr class="rowsearch">
									  <td class="text-center"><span class="fas fa-search fa-xs"></span></td>
										...
										<?php
											$query = "SELECT distinct fieldworkid FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
									  ...
									  <td><input list="SearchName" class="search" >
										<?php
											$query = "SELECT distinct name FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchOvertimeDate" class="search">
										<?php
											$query = "SELECT distinct fieldworkdate FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchDetails" class="search" disabled>
										<?php
											$query = "SELECT distinct details FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchStarttime" class="search" disabled>
										<?php
											$query = "SELECT distinct starttime FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchEndtime" class="search" disabled>
										<?php
											$query = "SELECT distinct endtime FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchMinutes" class="search" disabled>
										<?php
											$query = "SELECT distinct daytype FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchStatus" class="search" disabled>
										<?php
											$query = "SELECT distinct status FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchDateFiled" class="search" disabled>
										<?php
											$query = "SELECT distinct date_format(createddatetime, '%Y-%m-%d') as datefiled FROM portalfieldwork where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
								...
								<tbody id="result">
									...
									{ 
										...
										<tr class="<?php echo $rowclass; ?>">
											...
											<td style="width:9%;"><?php echo $row['fieldworkdate'];?></td>
											<td style="width:23%;"><?php echo $row['details'];?></td>
											...
											<td style="width:9%;"><?php echo $row['datefiled'];?></td>

											<td style="width:11%;"><?php echo $row['approvedby'];?></td>
	...
	<div class="modal-container">
		<div class="modal-content">
			...
			<div id="container" class="modal-content-container">
				<form name="myForm" accept-charset="utf-8" action="fieldworkformprocess.php" method="get">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<label>Details:</label>
							<input type="text" value="" placeholder="Overt Time Details" id="add-details" name="FWdetails" class="modal-textarea" required="required">
		...
		var locDaytypenum = "";
  		$(document).ready(function(){
			$('#datatbl tbody tr').click(function(){
				...
				locFieldDate = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(3)").text();
				locDetails = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(4)").text();
				locStartTime = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(10)").text();
				locEndTime = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(11)").text();
				locDaytype = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(7)").text();
				locStatus = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(8)").text();
				locDateFile = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(9)").text();
				locDaytypenum = $("#datatbl tr:eq("+ ($(this).index()+2) +") td:eq(12)").text();
		...
		$( ".search" ).on( "keydown", function(event) {
		  if(event.which == 13){
			...
			var data=[];
			 ...
			 $.ajax({
						type: 'GET',
						url: 'approvedfieldworkformprocess.php',
