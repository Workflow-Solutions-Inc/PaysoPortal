						...
						<div id="container1" class="full">
							<table width="100%" border="0" id="datatbl" class="table table-striped mainpanel-table">
								<thead>	
									...
									<tr class="rowsearch">
									  ...
									  <td><input list="SearchDateFiled" class="search" disabled>
										<?php
											$query = "SELECT distinct date_format(approvaldatetime, '%Y-%m-%d') as datefiled FROM portalleavefile where dataareaid = '$dataareaid' and status != 0";
											$result = $conn->query($query);	
								...
								<tbody id="result">
									...
									where pl.dataareaid = '$dataareaid' and status != 0
