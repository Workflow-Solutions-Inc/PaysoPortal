								...
								<thead>	
									...
									<tr class="rowsearch">
									  ...
									  <td><input list="SearchDateFiled" class="search" disabled>
										<?php
											$query = "SELECT distinct date_format(approvaldatetime, '%Y-%m-%d') as datefiled FROM logcorrection where dataareaid = '$dataareaid' and workerid = '$lognum' and status != 0";
											$result = $conn->query($query);	
	...
	<div class="modal-container">
		<div class="modal-content">
			...
			<div id="container" class="modal-content-container">
				<form name="myForm" accept-charset="utf-8" action="logapprovedformprocess.php" method="get">
					<div class="row">
		...
		$( ".search" ).on( "keydown", function(event) {
		  if(event.which == 13){
			...
			var data=[];
			 ...
			 $.ajax({
						type: 'GET',
						url: 'logapprovedformprocess.php',
