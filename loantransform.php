							...
							<table width="100%" style="border: 1px solid #d9d9d9;" id="datatbl" class="table table-striped mainpanel-table">
								<thead>
									<tr class="rowtitle">
										...
										<td style="width:20%;">Loan Type</td>
										<td style="width:20%;">Amount</td>
										<td style="width:20%;">Deducted Date</td>
								...
								<tbody id="result">
									<?php
									$query = "SELECT refpayrollid,payrollperiod,workerid,refvoucher,refaccountcode,deducteddate,
														format(ifnull(amount,0),2) as amount

														FROM loantrans 

														where dataareaid = '$dataareaid' 
														and workerid = '$wkid' 
														and refvoucher = '$lvouc' 
														
														order by deducteddate";
									...
									{ 
										...
										<tr  class="<?php echo $rowclass; ?>" tabindex="<?php echo $rowcnt2; ?>">
											...
											<td style="width:20%;"><?php echo $row['refpayrollid'];?></td>
											<td style="width:20%;"><?php echo $row['payrollperiod'];?></td>
											<td style="width:20%;"><?php echo $row['refvoucher'];?></td>
											<td style="width:20%;"><?php echo $row['refaccountcode'];?></td>
											<td style="width:20%;"><?php echo $row['amount'];?></td>
											<td style="width:20%;"><?php echo $row['deducteddate'];?></td>
										</tr>
									<?php }?>
								</tbody>
