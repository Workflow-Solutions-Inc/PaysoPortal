...
<body>-->
	...
	<div class="header">
		...
		<div class="header-nav">
				<ul>
					...
					<li id="ala" onClick="reply_click(this.id)"><a href="approverviewleaveformprocess.php?list=ala"><span class="fas fa fa-check"></span>  Approved Leave Application</a></li>
				</ul>
		</div>
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li><button onClick="RevertLeave();"><span class="fa fa-history"></span> Revert</button></li>
						...
						<div id="container1" class="full">
							<table width="100%" border="0" id="datatbl" class="table table-striped mainpanel-table">
								...
								<tbody id="result">
									...
									FROM portalleavefile where dataareaid = '$dataareaid' and status != 0
									order by leaveid";
									$result = $conn->query($query);
									$rowclass = "rowA";
									$rowcnt = 0;
									...
									{ 
										...
										<tr class="<?php echo $rowclass; ?>">
											...
											<td style="width:5%;"><input type='checkbox' id="chkbox" name="chkbox" class="checkbox" 
												value="<?php echo $row['leaveid'];?>" <?php echo ($row['status']==3 ? 'disabled' : '');?>></td>
		...
		$( ".search" ).on( "keydown", function(event) {
		  if(event.which == 13){
			...
			var data=[];
			 ...
			 $.ajax({
						type: 'GET',
						url: 'approverviewleaveformprocess.php',
