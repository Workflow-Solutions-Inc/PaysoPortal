						...
						<div id="container1" class="full">
							<table width="100%" border="0" id="datatbl" class="table table-striped mainpanel-table">
								<thead>	
									...
									<tr class="rowsearch">
									  ...
									  <td><input list="SearchStarttime" class="search" disabled>
										<?php
											$query = "SELECT distinct starttime FROM overtimefile where dataareaid = '$dataareaid' and status = 0";
											$result = $conn->query($query);	
									  ...
									  <td><input list="SearchEndtime" class="search" disabled>
										<?php
											$query = "SELECT distinct endtime FROM overtimefile where dataareaid = '$dataareaid' and status = 0";
											$result = $conn->query($query);	
								...
								<tbody id="result">
									...
									FROM overtimefile where dataareaid = '$dataareaid'
										and status = 0
									order by overtimeid";
									$result = $conn->query($query);
									$rowclass = "rowA";
									...
									{ 
										...
										<tr class="<?php echo $rowclass; ?>">
											...
											<td style="width:5%;"><?php echo $row['timein'];?></td>
											<td style="width:5%;"><?php echo $row['timeout'];?></td>
