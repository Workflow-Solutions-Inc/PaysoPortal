...
<body>-->
	...
	<div id="leftpanel" class="leftpanel">
		...
		<ul class="subbuttons">
			...
			<li><button onClick="ApproveOT();"><span class="fa fa-thumbs-up"></span> Approve</button></li>
			<li><button onClick="DisapproveOT();"><span class="fa fa-thumbs-down"></span> Disapprove</button></li>
							...
							<table width="100%" border="0" id="datatbl" class="table table-striped mainpanel-table">
								<thead>	
									<tr class="rowtitle">
										...
										<td style="width:6%;">HRS</td>
										<td style="width:6%;">MINS</td>
									...
									<tr class="rowsearch">
									  ...
									  <td><input list="SearchDateFiled" class="search" disabled>
										<?php
											$query = "SELECT distinct date_format(createddatetime, '%Y-%m-%d') as datefiled FROM overtimefile where dataareaid = '$dataareaid' and status = 0";
											$result = $conn->query($query);	
	...
	<div class="modal-container">
		<div class="modal-content">
			...
			<div id="container" class="modal-content-container">
				<form name="myForm" accept-charset="utf-8" action="approverovertimeformprocess.php" method="get">
					<div class="row">
						...
						<!--<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							...
							<input type="hidden" value="12:00 AM" placeholder="" id="add-otstarttime" name="OTstart" class="modal-textarea" required="required">

							<!--<label>End Time:</label>-->
							<input type="hidden" value="12:00 AM" placeholder="" id="add-otendtime" name="OTend" class="modal-textarea" required="required">
	...
	<script  type="text/javascript">
		...
		function checkExistForm()
		{
		    ...
		    if (Typefilter == 5)
			{
				...
				{
					alert('Overtime Start Date and Start Time must be within his/her attendance!');
					return false;
				}
				else
				{
					...
					{
						alert('Overtime End Date and End Time must not be greater than his/her Start of Shift Schedule!');
						return false;
					}
					else
					{
			...
			else
			{
				...
				{
					alert('Overtime End Date and End Time must be within his/her attendance!');
					return false;
				}
				else
				{
					...
					{
						alert('Overtime Start Date and Star Time must not be Less than his/her End of Shift Schedule!');
						return false;
					}
					else
					{
